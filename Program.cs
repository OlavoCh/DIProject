...
var carComplete = serviceProvider.GetService<CarComplete>(); //O conteiner ve que CarComplete precisa de ICarMotor ja foi registrado no addSingleton, e entrega o CarComplete pronto 
carComplete?.AddNewMotor("V8 Engine"); //Adiciona o motor V8 ao carro e printa os 2 metodos
